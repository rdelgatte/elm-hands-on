...
var author$project$Dice$Rolled = function (a) {
	return {$: 'Rolled', a: a};
};
...
var author$project$Dice$generate = F2(
	function (min, max) {
		return A2(
			elm$random$Random$generate,
			author$project$Dice$Rolled,
			A2(elm$random$Random$int, min, max));
	});
var author$project$Dice$initialModel = function (_n0) {
	return _Utils_Tuple2(
		{value: 0},
		A2(author$project$Dice$generate, 1, 6));
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$Dice$subscriptions = function (model) {
...
var author$project$Dice$update = F2(
	function (msg, model) {
		if (msg.$ === 'Roll') {
			...
			var randomValue = msg.a;
			return _Utils_Tuple2(
				{value: randomValue},
				elm$core$Platform$Cmd$none);
		}
	});
var author$project$Dice$Roll = {$: 'Roll'};
...
var author$project$Dice$view = function (model) {
	var diceValue = elm$html$Html$text(
		A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Dice$Roll),
...
var author$project$Dice$main = elm$browser$Browser$element(
	{init: author$project$Dice$initialModel, subscriptions: author$project$Dice$subscriptions, update: author$project$Dice$update, view: author$project$Dice$view});
_Platform_export({'Dice':{'init':author$project$Dice$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Dice.Msg","aliases":{},"unions":{"Dice.Msg":{"args":[],"tags":{"Roll":[],"Rolled":["Basics.Int"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));